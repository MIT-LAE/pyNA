...
class TestGroundEffects(unittest.TestCase):
	...
	def test_evaluate(self):
		...
		f = compute_frequency_bands(settings['n_frequency_bands'])
		f_sb = compute_frequency_subbands(f, settings['n_frequency_subbands'])
		
		msap_ge = compute_ground_effects(msap_sb, rho_0, c_bar, r, beta, f_sb, x_obs, settings)
