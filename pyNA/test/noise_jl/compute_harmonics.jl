...
comp = "fan_inlet"
theta = 50.0
tonlv_I = 36.01410035962613
i_cut = 0.0
M_tip = 1.9086795394701983
bpf = 1706.8251146945638
x = vcat(theta, tonlv_I, i_cut, M_tip, bpf)
y = zeros(24)

# Compute
println("--- Compute ---")
@time inlet_harmonics_fwd!(y, x)
println(y)
...
const f_tape = JacobianTape(inlet_harmonics_fwd!, Y, X)
