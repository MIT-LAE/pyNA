...
function landing_gear!(spl, settings, ac, f, M_0, c_0, theta, phi, I_landing_gear, hsr_supp)
    ...
    if settings["airframe_hsr_calibration"]            
        @. spl += I_landing_gear*(pow_level_af_ng_w * F_ng_w + pow_level_af_ng_s * F_ng_s + pow_level_af_mg_w * F_mg_w + pow_level_af_mg_s * F_mg_s) * hsr_supp
    else
        @. spl += I_landing_gear*(pow_level_af_ng_w * F_ng_w + pow_level_af_ng_s * F_ng_s + pow_level_af_mg_w * F_mg_w + pow_level_af_mg_s * F_mg_s)
    end
