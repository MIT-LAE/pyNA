function normalization_jet_mixing(settings::PyObject, V_j, rho_j, A_j, Tt_j, c_0, rho_0, T_0)
...
function normalization_jet_shock(settings::PyObject, V_j, A_j, Tt_j, c_0, T_0)
...
function normalization_jet(settings::PyObject, V_j, rho_j, A_j, Tt_j, c_0, rho_0, T_0)
...
function normalization_core_ge(settings::PyObject, mdoti_c, Tti_c, Ttj_c, Pti_c, DTt_des_c, c_0, rho_0, T_0, p_0)
...
function normalization_core_pw(settings::PyObject, mdoti_c, Tti_c, Ttj_c, Pti_c, rho_te_c, c_te_c, rho_ti_c, c_ti_c, c_0, rho_0, T_0, p_0)
...
function normalization_fan(settings::PyObject, DTt_f ,mdot_f, N_f, A_f, d_f, c_0, rho_0, T_0)
