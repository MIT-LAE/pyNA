...
class TestComputeSPL(unittest.TestCase):
	...
	def test_evaluate(self):
		...
		ans = compute_geometry(x, y, z, alpha, gamma, t_s, c_0, T_0, x_mic)
	...
	def test_jax(self):
		...
		f_prime_0 = jax.jacrev(compute_geometry, argnums=0)
		...
		f_prime_1 = jax.jacrev(compute_geometry, argnums=1)
		...
		f_prime_2 = jax.jacrev(compute_geometry, argnums=2)
		...
		f_prime_3 = jax.jacrev(compute_geometry, argnums=3)
		...
		f_prime_4 = jax.jacrev(compute_geometry, argnums=4)
		...
		f_prime_5 = jax.jacrev(compute_geometry, argnums=5)
		...
		f_prime_6 = jax.jacrev(compute_geometry, argnums=6)
		...
		f_prime_7 = jax.jacrev(compute_geometry, argnums=7)
