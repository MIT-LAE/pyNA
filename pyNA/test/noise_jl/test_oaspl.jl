...
@testset "oaspl module" begin
	...
	spl = reshape([37.1, 44.9, 52.6, 59.3, 65.7, 72.2, 77.7, 82.9, 87.8, 92.5, 96.5,100.3,104.0,107.2,110.2,113.3,115.9,118.3,120.6,122.7,124.3,125.6,126.4,126.7], (1, 24))
