    ...
    * ``outputs['I_0']``:           ambient characteristic impedance [kg/m2/s]
    ...
    def compute(self, inputs: openmdao.vectors.default_vector.DefaultVector, outputs: openmdao.vectors.default_vector.DefaultVector):
        ...
        if settings.atmosphere_type == 'stratified':
            ...
            outputs['T_0'] = self.varAtm['T0']
            outputs['p_0'] = self.varAtm['p0']
            outputs['rho_0'] = self.varAtm['rho0']
            outputs['drho_0_dz'] = 0.
            outputs['c_0'] = self.varAtm['c0']
            outputs['mu_0'] = self.varAtm['mu0']
            outputs['I_0'] = self.varAtm['I_0']
            outputs['rh'] = self.varAtm['rh0']
